...
SELECT 
    ...
    , CASE WHEN cDID_800Transfer = @OPuebla THEN 'Puebla' WHEN cDID_800Transfer IN (@ONacionalA,@ONacionalB)  THEN 'Nacional' END AS 800_transfer
    , CASE
    ...
    , COUNT(CASE WHEN cTelefono_Origen != cTelefono_Digitado AND cTelefono_Digitado IS NOT NULL THEN 1 END) as linea_diferente
...
GROUP BY fecha, 800_transfer, centro_transferencia, menu, opcion
